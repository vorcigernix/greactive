export const FAQ = [
	...
	},
	{
		...
		answer: 'We expect you to speak English at the hackathon to include everyone and enable everyone communicate with each other. Within the team, you can communicate in whatever language you prefer.'
	},
	{
		question: 'Can we apply as a team?',
		answer: 'No, each of your team members has to apply individually. You can assemble a team if you all pass the selection.'
	},
	{
		question: 'Anything else?',
		answer: 'Feel free to contact us via mail:',
		link: 'hackathon@socialbakers.com'
	},
]
